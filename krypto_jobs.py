...
# import the functions from crypto_wallet
...
candidate_database = {
    "Lane": [
        ...
        "4.3",
        0.20,
        "C:/Users/dinau/Downloads/lane.jpeg",  # Adjust the file path
    ],
    "Ash": [
        "Ash",
        ...
        "5.0",
        0.33,
        "C:/Users/dinau/Downloads/ash.jpeg",  # Adjust the file path
    ],
    "Jo": [
        "Jo",
        ...
        "4.7",
        0.19,
        "C:/Users/dinau/Downloads/jo.jpeg",  # Adjust the file path
    ],
    "Kendall": [
        "Kendall",
        "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45",
        "4.1",
        0.16,
        "C:/Users/dinau/Downloads/kendall.jpeg",  # Adjust the file path
    ],
}
...
def get_people():
    ...
    for number in range(len(people)):
        candidate_name = db_list[number][0]
        ethereum_address = db_list[number][1]
        rating = db_list[number][2]
        hourly_rate = db_list[number][3]
        image_path = db_list[number][4]

        st.write("Name: ", candidate_name)
        st.write("Ethereum Account Address: ", ethereum_address)
        st.write("KryptoJobs2Go Rating: ", rating)
        st.write("Hourly Rate per Ether: ", hourly_rate, "eth")

        # Display image using file path from the candidate database
...
# Streamlit application headings and introduction
st.markdown("# KryptoJobs2Go!")
st.markdown("## Hire A Fintech Professional!")
st.markdown("""
Welcome to KryptoJobs2Go, your platform for hiring top-notch fintech professionals securely using Ethereum transactions!

With KryptoJobs2Go, you can browse through a curated list of talented candidates, view their Ethereum account addresses, ratings, and hourly rates, and easily hire them for your fintech projects.

Simply select a candidate from the sidebar, specify the number of hours you'd like to hire them for, and click the 'Send Transaction' button to initiate the payment securely using blockchain technology.

Explore our platform and start hiring the best fintech talent today!
---
""")
st.text(" \n")
