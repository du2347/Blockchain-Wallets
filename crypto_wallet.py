...
from web3 import Account, Web3  # Import Web3 and Account

################################################################################
# Load environment variables
load_dotenv("C:\\Users\\dinau\\Downloads\\env.env")
...
def generate_account():
    ...
    # Print out the value of the mnemonic for diagnostic purposes
...
def send_transaction(w3, account, to, wage):
    ...
    value = Web3.toWei(wage, "ether")  # Use Web3.toWei() instead of Web3.toWei()
    ...
    raw_tx = {
        ...
        "value": value,
        "gas": gasEstimate,
        "gasPrice": 50000000,  # You can adjust this gas price as needed
